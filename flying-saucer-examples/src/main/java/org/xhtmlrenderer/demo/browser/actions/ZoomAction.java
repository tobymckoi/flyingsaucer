...
//    private static boolean needsWarning = true;
    ...
    private final XHTMLPanel view;

    public ZoomAction(XHTMLPanel panel, ScaleFactor factor) {
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        float scaleFactor = (float) scalingFactor.getFactor();
        
        view.getSharedContext().setDotsPerPixel(scaleFactor);
        view.getSharedContext().setDPI(106f * scaleFactor);
        view.resetBoxAndLayout();
