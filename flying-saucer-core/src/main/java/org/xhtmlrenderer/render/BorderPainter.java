...
public class BorderPainter {
    ...
    private static void paintDoubleBorder(
        ...
        paintSolid(outputDevice, bounds, border, 3, 1/3f, sides, currentSide, bevel);
    }
    ...
    private static void paintPatternedRect(OutputDevice outputDevice, 
        ...
        if (currentSide == BorderPainter.TOP) {
            ...
            stroke = new BasicStroke(border.top(), BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL, 0, pattern, xOffset);
        } else if (currentSide == BorderPainter.LEFT) {
            outputDevice.setColor(color.leftColor());
            stroke = new BasicStroke(border.left(), BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL, 0, pattern, 0);
        } else if (currentSide == BorderPainter.RIGHT) {
            outputDevice.setColor(color.rightColor());
            stroke = new BasicStroke(border.right(), BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL, 0, pattern, 0);
        } else if (currentSide == BorderPainter.BOTTOM) {
            outputDevice.setColor(color.bottomColor());
            stroke = new BasicStroke(border.bottom(), BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL, 0, pattern, xOffset);
        } else {
